...
'filename', 'CHODME_031_3_SMA_TEPs(PREPOS)_Merge_epochs.set');
...
EEG = rename_events(EEG, {'A - Stimulation'}, '1');  
EEG = rename_events(EEG, {'B - Stimulation'}, '2');  
EEG = rename_events(EEG, {'C - Stimulation'}, '3');  
EEG = rename_events(EEG, {'D - Stimulation'}, '4');  
